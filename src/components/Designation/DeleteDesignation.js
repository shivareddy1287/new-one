...
const DeleteDesignation = () => {
  ...
  if (isDeleted) return <Navigate to={`/designation`} />;
    ...
    <div>
      <div className="cs_div_profile">
        ...
        <div className="cs_edit_div">
          <div>
            <Link to={`/designation`} className="cs_edit_employee_head_div">
              <div>
                <svg
              ...
              <div className="cs_edit_left_right_div">
                <div className="cs_edit_left_input_right_input">
                  <div className="cs_edit_input_div">
                    ...
                    <h1>{DesignationName}</h1>
                  </div>
                </div>
              </div>
              <div>
                <button onClick={() => dispatch(deleteDesignationAction(id))}>
                  Confirm Delete
                </button>
              </div>
            </div>
