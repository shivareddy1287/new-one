...
const ViewDetails = () => {
  ...
  const { isProfileUpdated } = users;
  if (isProfileUpdated) return <Navigate to={`/profile/${id}`} />;
  return (
    <div>
      <div className="cs_div_profile">
        ...
        {loading ? (
          ...
          <div className="cs_edit_div">
            <Link to={`/profile/${id}`} className="cs_edit_employee_head_div">
              <div>
                <svg
            ...
            <div className="cs_edit_form_div">
              ...
              <div>
                <div>
                  <Link to={`/profile/${id}`} className="cs_edit_link">
                    Cancel
                  </Link>
                </div>
              </div>
