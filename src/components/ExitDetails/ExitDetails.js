                ...
                <tbody>
                  {exitDetailsList?.map((exitDetailsEach) => (
                    <tr key={exitDetailsEach?.id}>
                      ...
                      <td>
                        <Link to={`/exitdetails/update/${exitDetailsEach?.id}`}>
                          Edit
                        </Link>
                      </td>
                      <td>
                        <Link to={`/exitdetails/delete/${exitDetailsEach?.id}`}>
                          Delete
                        </Link>
                      </td>
                      <td>
                        <Link to={`/exitdetails/view/${exitDetailsEach?.id}`}>
                          View
                        </Link>
                      </td>
                    </tr>
